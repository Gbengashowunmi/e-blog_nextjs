  ...
  return (
    <Dashboard>
      <div className="terms">
        ...
        Welcome to <strong>essential.ng</strong> <br />
        <br />
        These Terms of Service (“Terms”, “Terms of Service”) govern your use of
        our website located at e-blog.ng (together or individually “Service”)
        operated by <strong>essential.ng</strong> <br />
        <br />
        ...
        gbengalilmahn@yahoo.com so we can try to find a solution. These Terms
        apply to all visitors, users and others who wish to access or use
        Service. <br />
        <br />
        2. <strong>Communications</strong> <br />
        ...
        gbengalilmahn@yahoo.com. <br />
        <br />
        <h5>
          {" "}
          3. <strong>Contests, Sweepstakes and Promotions </strong>
        </h5>
        ...
        Service, Promotion rules will apply. <br />
        <br />
        <h5>
          {" "}
        ...
        that: <br />
        (i) Content is yours (you own it) and/or you have the right to use it
        and the right to grant us the rights and license as provided in these
        Terms, and <br />
        (ii) that the posting of your Content on or through Service does not
        ...
        of Service, who may also use your Content subject to these Terms. <br />
        <br />
        essential.ng has the right but not the obligation to monitor and edit
        all Content provided by users.
        <br />
        <br />
        In addition, Content found on or through this Service are the property
        of essential.ng or used with permission. You may not distribute, modify,
        ...
        <h5>
          {" "}
          7. <strong>No Use By Minors</strong>
        </h5>
        ...
        and usage of Service. <br />
        <br />
        <h5>
          {" "}
          8. <strong>Accounts</strong>
        </h5>
        ...
        essential.ng and its licensors. Service is protected by copyright,
        ...
        written consent of essential.ng. <br />
        <br />
        <h5>
          {" "}
          10. <strong>Copyright Policy</strong>
        </h5>
        ...
        to gbengalilmahn@yahoo.com, with the subject line: “Copyright
        ...
        for Copyright Infringement Claims” <br />
        <br />
        ...
        any Content found on and/or through Service on your copyright. <br />
        <br />
        <h5>
          {" "}
          11.{" "}
        ...
        You may provide us either directly at gbengalilmahn@yahoo.com or via
        ...
        agree that: <br /> (i) you shall not retain, acquire or assert any
        ...
        information from you or any third party; and <br />
        ...
        are not owned or controlled by essential.ng.
        <br />
        <br />
        essential.ng has no control over, and assumes no responsibility for the
        ...
        Service template for a website, blog, e-commerce store or app. <br />
        <br />
        ...
        ITEMS OBTAINED FROM US IS AT YOUR SOLE RISK. <br />
        <br />
        ...
        but not limited to a breach of Terms. <br />
        <br />
        ...
        its conflict of law provisions. <br />
        <br />
        ...
        to users, including registered users. <br />
        <br />
        <h5>
          {" "}
        ...
        <h5>
          {" "}
          20. <strong>Waiver And Severability</strong>
        </h5>
        ...
        <h5>
          {" "}
          21. <strong>Acknowledgement</strong>
        </h5>
